...
Elm.OpenspacesBoard = Elm.OpenspacesBoard || {};
Elm.OpenspacesBoard.make = function (_elm) {
   "use strict";
   _elm.OpenspacesBoard = _elm.OpenspacesBoard || {};
   if (_elm.OpenspacesBoard.values) return _elm.OpenspacesBoard.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var pageFooter = A2($Html.div,_U.list([$Html$Attributes.$class("footer")]),_U.list([]));
   var pageHeader = A2($Html.div,_U.list([$Html$Attributes.$class("header")]),_U.list([]));
   var makeSessionItem = function (session) {    return A2($Html.li,_U.list([$Html$Attributes.$class("session-item")]),_U.list([$Html.text(session.name)]));};
   var sessionList = function (sessions) {    return A2($Html.ul,_U.list([$Html$Attributes.$class("session-list")]),A2($List.map,makeSessionItem,sessions));};
   var view = function (model) {
      return A2($Html.div,_U.list([$Html$Attributes.id("container")]),_U.list([pageHeader,sessionList(model.sessions),pageFooter]));
   };
   var update = F2(function (action,model) {
      ...
      if (_p0.ctor === "NoOp") {
            ...
            return _U.update(model,{sessions: A2($List.sortBy,function (_) {    return _.startTime;},model.sessions)});
         }
   });
   var Sort = {ctor: "Sort"};
   var NoOp = {ctor: "NoOp"};
   var makeSession = F6(function (name,description,convener,startTime,endTime,location) {
      return {name: name,description: description,convener: convener,startTime: startTime,endTime: endTime,location: location};
   });
   var makeLocation = function (name) {    return {name: name};};
   var initialModel = {sessions: _U.list([A6(makeSession,
                                         "Is Scala Dead?",
                                         "Talking about Scala",
                                         "Bruce",
                                         "2016-02-29 09:45",
                                         ...
                                         ,A6(makeSession,"Talking about ponies","","Carl","2016-02-29 09:45","2016-02-29 10:45",makeLocation("Rumors"))])};
   var main = view(initialModel);
   var Model = function (a) {    return {sessions: a};};
   var SessionModel = F6(function (a,b,c,d,e,f) {    return {name: a,description: b,convener: c,startTime: d,endTime: e,location: f};});
   var LocationModel = function (a) {    return {name: a};};
   return _elm.OpenspacesBoard.values = {_op: _op
                                        ...
                                        ,Sort: Sort
                                        ,update: update
                                        ,makeSessionItem: makeSessionItem
